...
namespace SwitchPlus
{
    public partial class Switch : Form, SwitchServerApplication.ISwitchRemote
    {
        ...
        public Switch()
        {
            InitializeComponent();
            this.tmrSys.Start();
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width - 0, Height - 0, 5, 5));
            //SetWindowPos(this.Handle, (System.IntPtr)HWND_TOPMOST, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE);

            #region Sticky Window
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width - -1, Height - -1, 9, 9));
        ...
        private void Switch_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (key.GetValue("Switch") == null)
                    {
                        cbStUp.Checked = false;
                    }
                    else
                    {
                        cbStUp.Checked = true;
 ...
 MessageBoxDefaultButton.Button1);
    ...
    MessageBoxDefaultButton.Button1);
     ...
     MessageBoxDefaultButton.Button1);
        ...
        private void btnMirror_MouseEnter(object sender, EventArgs e)
        {
            this.pbMirrorInfo.Visible = true;
            this.btnMirror.Image = SwitchPlus.Properties.Resources.BtnMirrorFocus;
        }

        private void btnMirror_MouseHover(object sender, EventArgs e)
        {
            this.pbMirrorInfo.Visible = true;
            this.btnMirror.Image = SwitchPlus.Properties.Resources.BtnMirrorFocus;
        }

        private void btnMirror_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnMirror.Image = SwitchPlus.Properties.Resources.BtnMirrorPressed;
        }

        private void btnMirror_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnMirror.Image = SwitchPlus.Properties.Resources.BtnMirrorFocus;
        }

        private void btnMirror_MouseLeave(object sender, EventArgs e)
        {
            this.pbMirrorInfo.Visible = false;
            this.btnMirror.Image = SwitchPlus.Properties.Resources.BtnMirror;
        }

        private void btnShutdownM_MouseEnter(object sender, EventArgs e)
        {
            this.btnShutdownM.Image = SwitchPlus.Properties.Resources.ShutdownHover;
        }

        private void btnShutdownM_MouseHover(object sender, EventArgs e)
        {
            this.btnShutdownM.Image = SwitchPlus.Properties.Resources.ShutdownHover;
        }

        private void btnShutdownM_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnShutdownM.Image = SwitchPlus.Properties.Resources.ShutdownPress;
        }

        private void btnShutdownM_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnShutdownM.Image = SwitchPlus.Properties.Resources.Shutdown;
        }

        private void btnShutdownM_MouseLeave(object sender, EventArgs e)
        {
            this.btnShutdownM.Image = SwitchPlus.Properties.Resources.ShutdownNormal;
        }

        private void btnRestartM_MouseEnter(object sender, EventArgs e)
        {
            this.btnRestartM.Image = SwitchPlus.Properties.Resources.RestartHover;
        }

        private void btnRestartM_MouseHover(object sender, EventArgs e)
        {
            this.btnRestartM.Image = SwitchPlus.Properties.Resources.RestartHover;
        }

        private void btnRestartM_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnRestartM.Image = SwitchPlus.Properties.Resources.RestartPressed;
        }

        private void btnRestartM_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnRestartM.Image = SwitchPlus.Properties.Resources.Restart;
        }

        private void btnRestartM_MouseLeave(object sender, EventArgs e)
        {
            this.btnRestartM.Image = SwitchPlus.Properties.Resources.RestartNormal;
        }

        private void btnSleepM_MouseEnter(object sender, EventArgs e)
        {
            this.btnSleepM.Image = SwitchPlus.Properties.Resources.SleepHover;
        }

        private void btnSleepM_MouseHover(object sender, EventArgs e)
        {
            this.btnSleepM.Image = SwitchPlus.Properties.Resources.SleepHover;
        }

        private void btnSleepM_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnSleepM.Image = SwitchPlus.Properties.Resources.SleepPressed;
        }

        private void btnSleepM_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnSleepM.Image = SwitchPlus.Properties.Resources.Sleep;
        }

        private void btnSleepM_MouseLeave(object sender, EventArgs e)
        {
            this.btnSleepM.Image = SwitchPlus.Properties.Resources.SleepNormal;
        }

        private void btnHibernateM_MouseEnter(object sender, EventArgs e)
        {
            this.btnHibernateM.Image = SwitchPlus.Properties.Resources.HibernateHover;
        }

        private void btnHibernateM_MouseHover(object sender, EventArgs e)
        {
            this.btnHibernateM.Image = SwitchPlus.Properties.Resources.HibernateHover;
        }

        private void btnHibernateM_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnHibernateM.Image = SwitchPlus.Properties.Resources.Hibernate;
        }

        private void btnHibernateM_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnHibernateM.Image = SwitchPlus.Properties.Resources.HibernatePressed;
        }

        private void btnHibernateM_MouseLeave(object sender, EventArgs e)
        {
            this.btnHibernateM.Image = SwitchPlus.Properties.Resources.HibernateNormal;
        }

        private void btnLogoffM_MouseEnter(object sender, EventArgs e)
        {
            this.btnLogoffM.Image = SwitchPlus.Properties.Resources.LogoffHover;
        }

        private void btnLogoffM_MouseHover(object sender, EventArgs e)
        {
            this.btnLogoffM.Image = SwitchPlus.Properties.Resources.LogoffHover;
        }

        private void btnLogoffM_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnLogoffM.Image = SwitchPlus.Properties.Resources.LogoffPressed;
        }

        private void btnLogoffM_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnLogoffM.Image = SwitchPlus.Properties.Resources.Logoff;
        }

        private void btnLogoffM_MouseLeave(object sender, EventArgs e)
        {
            this.btnLogoffM.Image = SwitchPlus.Properties.Resources.LogoffNormal;
        }

        private void btnLockM_MouseEnter(object sender, EventArgs e)
        {
            this.btnLockM.Image = SwitchPlus.Properties.Resources.LockHover;
        }

        private void btnLockM_MouseHover(object sender, EventArgs e)
        {
            this.btnLockM.Image = SwitchPlus.Properties.Resources.LockHover;
        }

        private void btnLockM_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnLockM.Image = SwitchPlus.Properties.Resources.LockPressed;
        }

        private void btnLockM_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnLockM.Image = SwitchPlus.Properties.Resources.Lock;
        }

        private void btnLockM_MouseLeave(object sender, EventArgs e)
        {
            this.btnLockM.Image = SwitchPlus.Properties.Resources.LockNormal;
        }

        private void rbBroadcast_MouseEnter(object sender, EventArgs e)
        {
            this.pbBroadcastingInfo.Visible = true;
            if (SwitchPlus.Program.broadcast == true)
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
            else
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonDH;
        }

        private void rbBroadcast_MouseHover(object sender, EventArgs e)
        {
            this.pbBroadcastingInfo.Visible = true;
            if (SwitchPlus.Program.broadcast == true)
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
        ...
        private void rbBroadcast_MouseDown(object sender, MouseEventArgs e)
        {
            if (SwitchPlus.Program.broadcast == true)
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonAP;
            else
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonDP;
        }

        private void rbBroadcast_MouseUp(object sender, MouseEventArgs e)
        {
            if (SwitchPlus.Program.broadcast == true)
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            else
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonD;
        }

        private void rbBroadcast_MouseLeave(object sender, EventArgs e)
        {
            this.pbBroadcastingInfo.Visible = false;
            if (SwitchPlus.Program.broadcast == true)
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            else
                this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonD;
        ...
        private void rbBroadcast_Click(object sender, EventArgs e)
        {
            if (SwitchPlus.Program.broadcast == false)
            {
                try
                {
                    ...
                    _VServer = new ImageStreamer(Convert.ToInt32(nudWidth.Value), Convert.ToInt32(nudHeight.Value), Convert.ToInt32(nudPort.Value));
                    _VServer.Start(Convert.ToInt32(nudPort.Value));
                    this.tmrClients.Start();
                    SwitchPlus.Program.broadcast = true;
                    this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonA;
                    this.lblClientInfo.ForeColor = Color.DarkGray;
                    this.lblClientInfo.Text = "Connected Clients : ";
                    this.pbBCIcon.Image = SwitchPlus.Properties.Resources.BroadcasterActive;
                    this.pnlBrdInfo.Visible = true;
                    this.lblBrdInfo.Text = "Connect using:  " + string.Format(@"http://{0}:{1}", lblIPAdd.Text, nudPort.Value.ToString());
                }
                catch
                {
                    MessageBox.Show("Unable to Broadcast! Try again with different port number.", "Switch", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                    SwitchPlus.Program.broadcast = false;
                    this.nudPort.Enabled = true;
                    this.nudWidth.Enabled = true;
                    this.nudHeight.Enabled = true;
                    this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonD;
                    this.pbBCIcon.Image = SwitchPlus.Properties.Resources.BroadcasterOff;
                    this.pnlBrdInfo.Visible = false;
                    this.lblBrdInfo.ResetText();
                }
            }
            else
            {
                ...
                {
                    _VServer.Stop();
                    this.tmrClients.Stop();
                    this.lblClientInfo.ForeColor = Color.Crimson;
                    this.lblClientInfo.Text = "Broadcaster Disabled";
                    SwitchPlus.Program.broadcast = false;
                    this.nudPort.Enabled = true;
                    this.nudWidth.Enabled = true;
                    this.nudHeight.Enabled = true;
                    this.rbBroadcast.Image = SwitchPlus.Properties.Resources.RadioButtonD;
                    this.pbBCIcon.Image = SwitchPlus.Properties.Resources.BroadcasterOff;
                    pnlBrdInfo.Visible = false;
                }
                catch
                {
                    MessageBox.Show("Unable to Stop Broadcast! Try Again...!", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                }
            }
        }

        private void rbBrutallyM_MouseEnter(object sender, EventArgs e)
        {
            this.pbBrutallyMInfo.Visible = true;
            if (SwitchPlus.Program.brutallyM == true)
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
            else
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonDH;
        }

        private void rbBrutallyM_MouseHover(object sender, EventArgs e)
        {
            this.pbBrutallyMInfo.Visible = true;
            if (SwitchPlus.Program.brutallyM == true)
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
        ...
        private void rbBrutallyM_MouseDown(object sender, MouseEventArgs e)
        {
            if (SwitchPlus.Program.brutallyM == true)
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonAP;
            else
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonDP;
        }

        private void rbBrutallyM_MouseUp(object sender, MouseEventArgs e)
        {
            if (SwitchPlus.Program.brutallyM == true)
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            else
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonD;
        }

        private void rbBrutallyM_MouseLeave(object sender, EventArgs e)
        {
            this.pbBrutallyMInfo.Visible = false;
            if (SwitchPlus.Program.brutallyM == true)
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            else
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonD;
        ...
        private void rbBrutallyM_Click(object sender, EventArgs e)
        {
            if (SwitchPlus.Program.brutallyM == false)
            {
                SwitchPlus.Program.brutallyM = true;
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            }
            else
            {
                SwitchPlus.Program.brutallyM = false;
                this.rbBrutallyM.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            }
        }

        private void btnMonitor_MouseEnter(object sender, EventArgs e)
        {
            this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorFocus;
        }
        ...
        private void btnMonitor_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorFocus;
        }

        private void btnMonitor_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorPressed;
        }

        private void btnMonitor_MouseLeave(object sender, EventArgs e)
        {
            if (this.pnlMonitor.Visible == true)
                this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorPressed;
            else
                this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitor;
        }

        private void btnMonitor_Click(object sender, EventArgs e)
        {
            this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorPressed;
            if (this.pnlMonitor.Visible == false)
            {
                DialogResult dr = MessageBox.Show("Do you want to get list of connected systems? It will take time to generate the list.\nChoose 'No' to continue.", "Switch", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button3);
                if (dr == System.Windows.Forms.DialogResult.Yes)
                {
                    if (this.pnlMonitor.Visible == true)
                    {
                        this.pnlMonitor.Visible = false;
                        this.pbPnlArw.Visible = false;
                        this.pnlMonitorWait.Visible = false;
                    }
                    else
                    {
                        this.pbArwBC.Visible = false;
                        this.pnlBroadcaster.Visible = false;
                        this.pbPnlArw.Visible = true;
                        this.pnlMonitorWait.Visible = true;
                        this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorPressed;
                        try
                        {
                            this.cmbNetComp.Items.Clear();
                            NetworkBrowser nb = new NetworkBrowser();
                            foreach (string pc in nb.getNetworkComputers())
                            {
                                this.cmbNetComp.Items.Add(pc);
                            }
                            this.pnlMonitor.Visible = true;
                            this.pnlMonitorWait.Visible = false;
                            this.rbIP.Enabled = true;

                        }
                        catch (Exception ex)
                        {
                            MessageBox.Show("An Error Occurred while Trying to Access the Network Computers!", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            this.cmbNetComp.Items.Clear();
                            this.pnlMonitor.Visible = true;
                            this.pnlMonitorWait.Visible = false;
                            this.cmbNetComp.Visible = false;
                            this.txtIP.Visible = true;
                            this.txtIP.ResetText();
                            this.rbIP.Enabled = false;
                        }
                ...
                else if (dr == System.Windows.Forms.DialogResult.No)
                {
                    ...
                    this.pnlMonitorWait.Visible = false;
                    this.cmbNetComp.Visible = false;
                    rbIP.Image = SwitchPlus.Properties.Resources.rb2;
                    this.btnMonitor.Image = SwitchPlus.Properties.Resources.BtnMonitorPressed;
                    this.txtIP.Visible = true;
                    this.txtIP.ResetText();
                    this.rbIP.Enabled = true;
        ...
        private void btnBroadcaster_Click(object sender, EventArgs e)
        {
            if (this.pnlBroadcaster.Visible == true)
            {
                this.pnlBroadcaster.Visible = false;
                this.pbArwBC.Visible = false;
            ...
            else
            {
                try
                {
                    this.pnlBroadcaster.Visible = true;
                    this.pbArwBC.Visible = true;
                    this.pbPnlArw.Visible = false;
                    this.pnlMonitor.Visible = false;
                    this.nudWidth.Maximum = SystemInformation.PrimaryMonitorSize.Width;
                    this.nudHeight.Maximum = SystemInformation.PrimaryMonitorSize.Height;
                    this.nudWidth.Value = SystemInformation.PrimaryMonitorSize.Width;
                    this.nudHeight.Value = SystemInformation.PrimaryMonitorSize.Height;
                    this.lblSysName.Text = Dns.GetHostName();
                    this.lblIPAdd.Text = Dns.GetHostByName(Dns.GetHostName()).AddressList[0].ToString();
                }
                catch (Exception ex)
                {
                    MessageBox.Show("An Error Occurred while Trying to Retrieve System Details!", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.pnlBroadcaster.Visible = false;
                    this.pbArwBC.Visible = false;
                    this.lblIPAdd.ResetText();
                    this.lblSysName.ResetText();
                    this.nudWidth.Value = 1000;
                    this.nudHeight.Value = 500;
                    this.nudPort.Value = 8080;
                }
            }
        }

        private void tmrClients_Tick(object sender, EventArgs e)
        {
            int count = (_VServer.Clients != null) ? _VServer.Clients.Count() : 0;
            this.lblClientInfo.Text = "Connected Clients : " + count.ToString();
        ...
        private void btnBroadcaster_MouseEnter(object sender, EventArgs e)
        {
            this.btnBroadcaster.Image = SwitchPlus.Properties.Resources.BtnBroadcasterFocus;
        }

        private void btnBroadcaster_MouseHover(object sender, EventArgs e)
        {
            this.btnBroadcaster.Image = SwitchPlus.Properties.Resources.BtnBroadcasterFocus;
        }

        private void btnBroadcaster_MouseDown(object sender, MouseEventArgs e)
        {
            this.btnBroadcaster.Image = SwitchPlus.Properties.Resources.BtnBroadcasterPressed;
        }

        private void btnBroadcaster_MouseUp(object sender, MouseEventArgs e)
        {
            this.btnBroadcaster.Image = SwitchPlus.Properties.Resources.BtnBroadcasterFocus;
        }

        private void btnBroadcaster_MouseLeave(object sender, EventArgs e)
        {
            if (this.pnlBroadcaster.Visible == true)
                this.btnBroadcaster.Image = SwitchPlus.Properties.Resources.BtnBroadcasterPressed;
            else
                this.btnBroadcaster.Image = SwitchPlus.Properties.Resources.BtnBroadcaster;
        }

        private void rbIP_MouseEnter(object sender, EventArgs e)
        {
            if (this.cmbNetComp.Visible == true)
                rbIP.Image = SwitchPlus.Properties.Resources.rb1A;
            else
                rbIP.Image = SwitchPlus.Properties.Resources.rb2A;
        }

        private void rbIP_MouseHover(object sender, EventArgs e)
        {
            if (this.cmbNetComp.Visible == true)
                rbIP.Image = SwitchPlus.Properties.Resources.rb1A;
            else
        ...
        private void rbIP_MouseLeave(object sender, EventArgs e)
        {
            if (this.cmbNetComp.Visible == true)
                rbIP.Image = SwitchPlus.Properties.Resources.rb1;
            else
                rbIP.Image = SwitchPlus.Properties.Resources.rb2;
        }
        ...
        {
            if (this.cmbNetComp.Visible == true && this.cmbNetComp.Text == "")
            {
                MessageBox.Show("Please select the system from the list. System name can't be empty.", "Switch",MessageBoxButtons.OK, MessageBoxIcon.Exclamation,MessageBoxDefaultButton.Button1);
                return;
            }
            else if(txtIP.Visible == true && txtIP.Text == "")
            {
                MessageBox.Show("Please enter the IP address. System IP address can't be empty.", "Switch", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                return;
            }
            string path = null;
            string fileName;
            ...
            else if (System.IO.File.Exists(@"VLC\VLC.exe"))
                path = @"VLC\VLC.exe";
            else
            {
                if (this.ofdb.ShowDialog() == DialogResult.OK)
                {
                    fileName = System.IO.Path.GetFileName(ofdb.FileName);
                    path = System.IO.Path.GetDirectoryName(ofdb.FileName);
                    path = path + @"\" + fileName;
                }
            }

            if ((this.cmbNetComp.Visible == true) && !(this.cmbNetComp.Text.Equals(null)))
            {
                IPHostEntry ihe = Dns.GetHostByName(cmbNetComp.Text.Trim());
                IPAddress ip = ihe.AddressList[0];
                System.Diagnostics.Process.Start(path, "-vvv " + "http://" + ip.ToString().Trim() + ":9999");
            }
            else if((this.txtIP.Visible == true)&& !(this.txtIP.Text.Equals(null)))
            {
                IPAddress ip;
                ...
                {
                    MessageBox.Show("Invalid IP Address! Please Enter Valid IP Adddress.", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    txtIP.Focus();
                    txtIP.SelectAll();
                }
            ...
            {
                MessageBox.Show("Invalid Host Name. Please Select Valid Host Name.", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }

        private void btnShutdownM_Click(object sender, EventArgs e)
        {
            try
            {
                SwitchRemoteServices.ISwitchService remServive = null;
                // Get a TCP channel
                TcpChannel tc = new TcpChannel();
                ChannelServices.RegisterChannel(tc);

                //WellKnownClientTypeEntry remotetype = new WellKnownClientTypeEntry(typeof(SwitchServiceClass), "tcp://" + textBox1.Text + ":61001/TcpService");
                WellKnownClientTypeEntry remotetype = null;
                if ((this.cmbNetComp.Visible == true) && !(this.cmbNetComp.Text.Equals(null)))
                {
                    IPHostEntry ihe = Dns.GetHostByName(cmbNetComp.Text.Trim());
                    IPAddress ip = ihe.AddressList[0];
                    remotetype = new WellKnownClientTypeEntry(typeof(SwitchServiceClass), "tcp://" + ip.ToString() + ":61001/TcpService");
                }
                else if ((this.txtIP.Visible == true) && !(this.txtIP.Text.Equals(null)))
                {
                    IPAddress ip;
                    if (IPAddress.TryParse(txtIP.Text, out ip))
                    {
                        remotetype = new WellKnownClientTypeEntry(typeof(SwitchServiceClass), "tcp://" + ip.ToString().Trim() + ":61001/TcpService");
                    }
                    else
                    {
                        MessageBox.Show("Invalid IP Address! Please Enter Valid IP Adddress.", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                remServive = new SwitchServiceClass();
                DateTime dt = remServive.getSwitchStartTime();
                remServive.remoteExecute(1, SwitchPlus.Program.brutallyM);                
                ChannelServices.UnregisterChannel(tc);
            }
            catch
            {
                MessageBox.Show("Unable to Execute at Remote Machine.", "Error - Switch", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }

        private void btnLockM_Click(object sender, EventArgs e)
        {
            try
            {
                SwitchRemoteServices.ISwitchService remServive = null;
                ...
                remServive = new SwitchServiceClass();
                DateTime dt = remServive.getSwitchStartTime();
                remServive.remoteExecute(6, SwitchPlus.Program.brutallyM);
                ChannelServices.UnregisterChannel(tc);
            }
            catch
            {
        ...
        private void btnRestartM_Click(object sender, EventArgs e)
        {
            try
            {
                SwitchRemoteServices.ISwitchService remServive = null;
                ...
                remServive = new SwitchServiceClass();
                DateTime dt = remServive.getSwitchStartTime();
                remServive.remoteExecute(2, SwitchPlus.Program.brutallyM);
                ChannelServices.UnregisterChannel(tc);
            }
            catch
            {
        ...
        private void btnSleepM_Click(object sender, EventArgs e)
        {
            try
            {
                SwitchRemoteServices.ISwitchService remServive = null;
                ...
                remServive = new SwitchServiceClass();
                DateTime dt = remServive.getSwitchStartTime();
                remServive.remoteExecute(3, SwitchPlus.Program.brutallyM);
                ChannelServices.UnregisterChannel(tc);
            }
            catch
            {
        ...
        private void btnHibernateM_Click(object sender, EventArgs e)
        {
            try
            {
                SwitchRemoteServices.ISwitchService remServive = null;
                ...
                remServive = new SwitchServiceClass();
                DateTime dt = remServive.getSwitchStartTime();
                remServive.remoteExecute(4, SwitchPlus.Program.brutallyM);
                ChannelServices.UnregisterChannel(tc);
        ...
        private void btnLogoffM_Click(object sender, EventArgs e)
        {
            try
            {
                SwitchRemoteServices.ISwitchService remServive = null;
                ...
                remServive = new SwitchServiceClass();
                DateTime dt = remServive.getSwitchStartTime();
                remServive.remoteExecute(5, SwitchPlus.Program.brutallyM);
                ChannelServices.UnregisterChannel(tc);
            }
            catch
            {
        ...
        {
            if(SwitchPlus.Program.broadcast)
            {
                _VServer.Stop();
                this.tmrClients.Stop();
            }
        ...
        private void cbStUp_CheckedChanged(object sender, EventArgs e)
        {
            if (cbStUp.Checked == true)
            {
                try
                {
                    using (RegistryKey key = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true))
            ...
            else if (cbStUp.Checked == false)
            {
                try
                {
                    using (RegistryKey key = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true))
                    {
                        key.DeleteValue("Switch", false);
                    }
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to find 'Switch' at Windows Start Up.\n" + ex.ToString(), "Switch", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                }

            }
        }

        private void rbSwitch_Click(object sender, EventArgs e)
        {
            if (this.isStartRemot == false)
            {
                if (msc != null)
                {
                    msc.Stop();
                ...
                else
                {
                    try
                    {
                        ...
                        msc = new MicroServerCore((IPAddress)cmbBoxIP.SelectedItem, Convert.ToInt32(nudRPort.Value));
                        this.isStartRemot = true;
                        rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonA;
                        //this.BackgroundImage = SwitchPlus.Properties.Resources.RemotellerC;
                        lblMessage.Text ="Connect using: " + string.Format(@"http://{0}:{1}", cmbBoxIP.SelectedItem.ToString(), nudRPort.Value.ToString());
                        pnlRPort.Enabled = false;
                        pnlIPAdd.Visible = false;
                        pnlRInfo.Visible = true;
                    }
                    catch (Exception ex)
                    {
                        MessageBox.Show("Unable to start Remoteller. Check IP address and port number." + ex.ToString(), "Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
            else
            {
                if (msc != null)
                {
                    msc.Stop();
                    msc = null;
                    cmbBoxIP.Visible = true;
                    nudRPort.Visible = true;
                    this.isStartRemot = false;
                    rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonD;
                    //this.BackgroundImage = Remoteller.Properties.Resources.Remoteller;
                }
                lblMessage.Text = string.Empty;
                pnlRPort.Enabled = true;
                pnlIPAdd.Visible = true;
                pnlRInfo.Visible = false;
            }  
        }

        private void rbSwitch_MouseDown(object sender, MouseEventArgs e)
        {
            if (this.isStartRemot)
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonAP;
            else
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonDP;
        }

        private void rbSwitch_MouseHover(object sender, EventArgs e)
        {
            pbRInfo.Visible = true;
            if (this.isStartRemot)
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
            else
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonDH;
        }

        private void rbSwitch_MouseEnter(object sender, EventArgs e)
        {
            pbRInfo.Visible = true;
            if (this.isStartRemot)
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
        ...
        private void rbSwitch_MouseLeave(object sender, EventArgs e)
        {
            pbRInfo.Visible = false;
            if (this.isStartRemot)
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonA;
            else
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonD;
        ...
        private void rbSwitch_MouseUp(object sender, MouseEventArgs e)
        {
            if (this.isStartRemot)
                rbSwitch.Image = SwitchPlus.Properties.Resources.RadioButtonAH;
            else
